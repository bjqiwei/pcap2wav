...
#include "string.h"
 ...
 //word16_t L1[L1_RANGE][NB_LSP_COEFF]; /* The first stage is a 10-dimensional VQ using codebook L1 with 128 entries (7 bits). in Q2.13 */
// word16_t L2L3[L2_RANGE][NB_LSP_COEFF]; 
...
// word16_t MAPredictorSum[L0_RANGE][NB_LSP_COEFF]; /* 1 - Sum(MAPredictor) in Q0.15 */
 //word16_t invMAPredictorSum[L0_RANGE][NB_LSP_COEFF]; 
